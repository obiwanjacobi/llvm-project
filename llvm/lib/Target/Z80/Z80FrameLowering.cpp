...
Z80FrameLowering::Z80FrameLowering(const Z80TargetMachine &tm)
  : TargetFrameLowering(TargetFrameLowering::StackGrowsDown, Align(1), -2), TM(tm)
{}
...
MachineBasicBlock::iterator Z80FrameLowering::eliminateCallFramePseudoInstr(MachineFunction &MF,
