...
Z80TargetMachine::Z80TargetMachine(const Target &T, const Triple &TT,
  ...
  : LLVMTargetMachine(T, 
      "e-p:16:8:8-i8:8:8-i16:8:8-i32:8:8-i64:8:8-f32:8:8-f64:8:8-n8:16", 
      TT, CPU, FS, Options, RM.getValueOr(Reloc::Static), 
...
Z80MetalTargetMachine::Z80MetalTargetMachine(const Target &T, const Triple &TT,
    StringRef CPU, StringRef FS, const TargetOptions &Options,
    Optional<Reloc::Model> RM, Optional<CodeModel::Model> CM,
    CodeGenOpt::Level OL, bool JIT)
  : Z80TargetMachine(T, TT, CPU, FS, Options, RM, CM, OL, JIT) {
}
